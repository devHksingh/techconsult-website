...
import { Mail, Phone, MapPin, Clock, Send, CheckCircle2, Loader2, Calendar, MessageSquare, AlertCircle } from "lucide-react";
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-300 leading-relaxed max-w-3xl mx-auto px-4">
              Ready to transform your business? Let's discuss how our IT consulting services can help you achieve your goals.
            </p>
          </motion.div>
        </div>
      </section>
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            className={`${errors.name ? "border-red-500" : "border-slate-300"} focus:border-blue-500 focus:ring-blue-500`}
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            className={`${errors.email ? "border-red-500" : "border-slate-300"} focus:border-blue-500 focus:ring-blue-500`}
                            disabled={isSubmitting}
                          />
                          {errors.email && (
                            <p className="text-sm text-red-500 mt-1 flex items-center gap-1">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className={`${errors.subject ? "border-red-500" : "border-slate-300"} focus:border-blue-500 focus:ring-blue-500`}
                          disabled={isSubmitting}
                        />
                        {errors.subject && (
                          <p className="text-sm text-red-500 mt-1 flex items-center gap-1">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          rows={6}
                          className={`${errors.message ? "border-red-500" : "border-slate-300"} focus:border-blue-500 focus:ring-blue-500 resize-none`}
                          disabled={isSubmitting}
                        />
                        {errors.message && (
                          <p className="text-sm text-red-500 mt-1 flex items-center gap-1">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {info.link && info.link !== "#" ? (
                            ...
                            <p className="text-sm text-slate-600 break-words">{info.content}</p>
                          )}
                          {info.subContent && (
                            <p className="text-sm text-slate-500 mt-1">{info.subContent}</p>
                          )}
                        </div>
                      </div>
                    </CardContent>
              ...
              >
                <Card className="border-none bg-gradient-to-br from-blue-600 to-cyan-500 text-white shadow-xl">
                  <CardHeader>
                    ...
                    <CardTitle className="text-white text-xl">Free Consultation</CardTitle>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg text-slate-600 mb-8">
              Our team is available for a quick call to discuss your needs and explore how we can help your business succeed.
            </p>
